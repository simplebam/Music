...
public abstract class OnPlayStatusChangedListener extends IOnPlayStatusChangedListener.Stub {
     ...
     * @param song   当前开始播放曲目
     * @param index  播放列表下标
     * @param status 播放状态，均为 {@link com.yueyue.musicodo.service.PlayController#STATUS_START}
     */
    @Override
     ...
     * @param song   当前播放曲目
     * @param index  播放列表下标
     * @param status 播放状态，为 {@link com.yueyue.musicodo.service.PlayController#STATUS_STOP}（
     */
    @Override
