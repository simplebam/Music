package com.yueyue.musicodo.app.manager;
...
/**
 * author : yueyue on 2018/2/27 20:59
 * desc   :
 */
...
public final class PermissionManager {
    ...
    //请求权限
    public void showPermissionRequestTip(final PerMap perMap, final Activity activity,
                                         final OnPermissionRequestRefuse refuse) {
            ...
            final Dialog dialog = provider.createPromptDialog(
                    ...
                    new DialogProvider.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat.requestPermissions(activity, perMap.permissions,
                                    perMap.category);
                        }
                    },
                    new DialogProvider.OnClickListener() {
