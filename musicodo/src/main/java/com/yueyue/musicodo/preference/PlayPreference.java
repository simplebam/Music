...
import com.yueyue.musicodo.db.MainSheetHelper;
import com.yueyue.musicodo.service.PlayController;


/**
 * author : yueyue on 2018/2/26 19:17
 * desc   : 播放界面配置：播放界面主题，播放模式，播放曲目、所属歌单、播放进度
 */
...
public class PlayPreference extends BasePreference {
    ...
    public PlayPreference(Context context) {
        super(context, PreferenceEnum.PLAY_PREFERENCE);
    }
    ...
    /**
     * 0 为全部，其它的歌单 信息 可从 {@link com.yueyue.musicodo.db.DBMusicocoController#getSheet(String)}等方法获得
     */
