...
import com.yueyue.musicodo.db.modle.Sheet;
...
/**
 * author : yueyue on 2018/2/26 22:49
 * desc   : 每个线程只能使用一个SQLiteOpenHelper，也就使得每个线程使用一个SQLiteDatabase对象（多线程操作数据库会报错）
 */
...
public class DBMusicocoController {
    ...
    private static final String TAG = DBMusicocoController.class.getSimpleName();
