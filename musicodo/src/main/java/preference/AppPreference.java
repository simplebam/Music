...
public class AppPreference extends BasePreference {
    ...
    public AppPreference(Context context) {
        super(context, PreferenceEnum.APP_PREFERENCE);
    }
    ...
    /**
     * 不要直接调用该方法，除非你确定此时应用主题为【白天】，应该使用{@link com.yueyue.musicodo.util.ColorUtils#getAccentColor(Context)}
     * 获取该值。
     *
     * @return 控件首选色
     */
